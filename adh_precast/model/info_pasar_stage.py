...
class AdhimixPreInfoPasarStage(models.Model):
    _name = "adhimix.pre.info.pasar.stage"
    ...
    def default_get(self, fields):
        ...
        return super(AdhimixPreInfoPasarStage, self.with_context(ctx)).default_get(fields)
